...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 26 00:34:30 2019
...
#%% data loader
#composed = transforms.Compose([Crop(2,130,20,148),Rescale(inputShape), Rgb2gray()])
...
for epoch in range(1,MAXEPOCH+1):
    ...
    for i_batch, sample_batched in enumerate(trainLoader):
        ...
        output, pretrain_feat = model(sample_batched['img'].float().to(DEVICE))
...
#%% plot
modName = '{}-tr{}-te{}-ep{}-in{}-bz{}-lr{}-k1{}_k2{}_k3{}'.format(MODINFO, TRAIN_NUM, TEST_NUM, MAXEPOCH,
